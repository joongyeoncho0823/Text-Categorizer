...
def text_categorize(train_input=0, test_input=0):
    ...
    test_output = input(
        'Enter the name of the desired text categorized predictions file: ')
...
train_input = input(
    "Enter the name of the labeled list of training documents: ")
test_input = input(
    "Enter the name of the list of testing documents to be categorized: ")
